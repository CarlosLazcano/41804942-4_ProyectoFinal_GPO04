...
int main( )
{
    ...
    //parte de teroía
    Model wall((char*)"Models/wall/wall.obj");
    Model stove((char*)"Models/stove/stove.obj");
    Model cabin((char*)"Models/cabin/cabin.obj");
    Model cabinup((char*)"Models/cabinup/cabinup.obj");
    Model frezz((char*)"Models/frezz/frezz.obj");
    Model micro((char*)"Models/microwave/microwave.obj");
    Model washer((char*)"Models/washer/washer.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //alacena01
        model = glm::mat4(1);
        model = glm::scale(model, glm::vec3(1.6, 1.6f, 1.75f));
        model = glm::translate(model, glm::vec3(-3.05f, 0.0f, -1.1f));
        model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, -1.0f, 0.0f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        cabin.Draw(shader);
        //Alacena02
        model = glm::mat4(1);
        model = glm::scale(model, glm::vec3(1.6, 1.6f, 1.75f));
        model = glm::translate(model, glm::vec3(-3.05f, 0.0f, 0.0f));
        model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, -1.0f, 0.0f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        cabin.Draw(shader);
        //Alacena flotante 01
        model = glm::mat4(1);        
        model = glm::translate(model, glm::vec3(-5.1f, 2.0f, -1.75f));
        model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, -1.0f, 0.0f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        cabinup.Draw(shader);
        //Alacena flotante 02
        model = glm::mat4(1);        
        model = glm::translate(model, glm::vec3(-5.1f, 2.0f, 0.25f));
        model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, -1.0f, 0.0f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        cabinup.Draw(shader);
        //Lavaplatos
        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(-5.1f, 0.0f, 1.1f));
        model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, -1.0f, 0.0f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        washer.Draw(shader);
        //microondas
        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(-5.0f, 1.15f, -2.0f));
        model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, -1.0f, 0.0f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        micro.Draw(shader);
        //
